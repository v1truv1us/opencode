...
| ------------------------------------- | ------- | --------------------------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT`               | string  | Satır içi JSON kimlik doğrulama bilgileri                                   |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS`    | boolean | npm paketlerinden beceri yüklemeyi devre dışı bırak                         |
...
| `OPENCODE_DISABLE_MOUSE`              | boolean | TUI'da fare yakalamayı devre dışı bırak                                     |
| `OPENCODE_DISABLE_PRUNE`              | boolean | Eski verilerin temizlenmesini devre dışı bırak                              |
| `OPENCODE_DISABLE_PROJECT_CONFIG`     | boolean | Proje düzeyinde yapılandırma yüklemeyi devre dışı bırak                     |
...
| `OPENCODE_MODELS_PATH`                | string  | Modeller JSON önbellek dosyası için özel yol                                |
...
| `EXA_API_KEY`                         | string  | Exa web araması için API anahtarı (`OPENCODE_ENABLE_EXA` gerektirir)        |
| `OTEL_EXPORTER_OTLP_ENDPOINT`         | string  | OpenTelemetry OTLP dışa aktarıcı uç noktası                                 |
| `OTEL_EXPORTER_OTLP_HEADERS`          | string  | OpenTelemetry OTLP dışa aktarıcı başlıkları                                 |
| `OTEL_RESOURCE_ATTRIBUTES`            | string  | OpenTelemetry kaynak nitelikleri (anahtar=değer çiftleri)                   |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI`                 | boolean | Effect HttpApi köprüsünü etkinleştir                    |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES`              | boolean | Deneysel çalışma alanlarını etkinleştir                 |
