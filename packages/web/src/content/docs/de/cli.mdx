...
| ------------------------------------- | --------------- | -------------------------------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT`               | Zeichenfolge    | Inline-JSON-Authentifizierungsdaten                                              |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS`    | boolescher Wert | Laden von Skills aus npm-Paketen deaktivieren                                    |
...
| `OPENCODE_DISABLE_MOUSE`              | boolescher Wert | Mausaufzeichnung in der TUI deaktivieren                                         |
| `OPENCODE_DISABLE_PRUNE`              | boolescher Wert | Bereinigung alter Daten deaktivieren                                             |
| `OPENCODE_DISABLE_PROJECT_CONFIG`     | boolescher Wert | Laden der Konfiguration auf Projektebene deaktivieren                            |
...
| `OPENCODE_MODELS_PATH`                | Zeichenfolge    | Benutzerdefinierter Pfad für JSON-Cachedatei der Modelle                         |
...
| `OPENCODE_TUI_CONFIG`                 | Zeichenfolge    | Pfad zur TUI-Konfigurationsdatei                                                 |
| `EXA_API_KEY`                         | Zeichenfolge    | API-Schlüssel für Exa-Websuche (erfordert `OPENCODE_ENABLE_EXA`)                 |
| `OTEL_EXPORTER_OTLP_ENDPOINT`         | Zeichenfolge    | OpenTelemetry OTLP-Exporter-Endpunkt                                             |
| `OTEL_EXPORTER_OTLP_HEADERS`          | Zeichenfolge    | OpenTelemetry OTLP-Exporter-Header                                               |
| `OTEL_RESOURCE_ATTRIBUTES`            | Zeichenfolge    | OpenTelemetry-Ressourcenattribute (Schlüssel=Wert-Paare)                         |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI`                 | boolescher Wert | Effect HttpApi-Bridge aktivieren                        |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES`              | boolescher Wert | Experimentelle Arbeitsbereiche aktivieren               |
