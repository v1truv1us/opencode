...
4. Cloudflare API 토큰을 입력하십시오.
   ...
   `CF_AIG_TOKEN`은 `CLOUDFLARE_API_TOKEN`의 별칭으로도 사용할 수 있습니다.
...
:::tip
`global` 리전은 가용성을 높이고 오류를 줄이며 추가 비용이 없습니다. `VERTEX_LOCATION=global`을 설정하여 사용하세요. 데이터 거주 요건이 있는 경우 지역 엔드포인트(예: `us-central1`)를 사용하십시오. [더 알아보기](https://cloud.google.com/vertex-ai/generative-ai/docs/partner-models/use-partner-models#regional_and_global_endpoints)
:::
