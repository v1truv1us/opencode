...
| Zmienna                               | Typ     | Opis                                                                   |
| ------------------------------------- | ------- | ---------------------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT`               | string  | Wbudowane poświadczenia autoryzacji JSON                               |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS`    | boolean | Wyłącz ładowanie skilli z pakietów npm                                 |
...
| `OPENCODE_DISABLE_MOUSE`              | boolean | Wyłącz przechwytywanie myszy w TUI                                     |
| `OPENCODE_DISABLE_PRUNE`              | boolean | Wyłącz czyszczenie starych wyników (pruning)                           |
| `OPENCODE_DISABLE_PROJECT_CONFIG`     | boolean | Wyłącz ładowanie konfiguracji na poziomie projektu                     |
...
| `OPENCODE_MODELS_PATH`                | string  | Niestandardowa ścieżka do pliku cache JSON modeli                      |
...
| `EXA_API_KEY`                         | string  | Klucz API dla wyszukiwania webowego Exa (wymaga `OPENCODE_ENABLE_EXA`) |
| `OTEL_EXPORTER_OTLP_ENDPOINT`         | string  | Endpoint eksportera OpenTelemetry OTLP                                 |
| `OTEL_EXPORTER_OTLP_HEADERS`          | string  | Nagłówki eksportera OpenTelemetry OTLP                                 |
| `OTEL_RESOURCE_ATTRIBUTES`            | string  | Atrybuty zasobów OpenTelemetry (pary klucz=wartość)                    |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI`                 | boolean | Włącz most Effect HttpApi                    |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES`              | boolean | Włącz eksperymentalne obszary robocze        |
