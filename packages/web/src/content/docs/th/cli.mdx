...
| ------------------------------------- | ------- | ---------------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT`               | String  | ข้อมูลรับรองการตรวจสอบสิทธิ์ JSON แบบ inline                     |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS`    | Boolean | ปิดใช้งานการโหลด skills จากแพ็คเกจ npm                           |
...
| `OPENCODE_DISABLE_MOUSE`              | Boolean | ปิดใช้งานการจับภาพเมาส์ใน TUI                                    |
| `OPENCODE_DISABLE_PRUNE`              | Boolean | ปิดใช้งานการลบข้อมูลเซสชันเก่า                                   |
| `OPENCODE_DISABLE_PROJECT_CONFIG`     | Boolean | ปิดใช้งานการโหลด config ระดับโปรเจกต์                            |
...
| `OPENCODE_MODELS_PATH`                | String  | เส้นทางที่กำหนดเองสำหรับไฟล์แคช JSON ของโมเดล                    |
...
| `EXA_API_KEY`                         | String  | คีย์ API สำหรับค้นหาเว็บ Exa (ต้องใช้ `OPENCODE_ENABLE_EXA`)     |
| `OTEL_EXPORTER_OTLP_ENDPOINT`         | String  | จุดสิ้นสุดตัวส่งออก OpenTelemetry OTLP                           |
| `OTEL_EXPORTER_OTLP_HEADERS`          | String  | ส่วนหัวตัวส่งออก OpenTelemetry OTLP                              |
| `OTEL_RESOURCE_ATTRIBUTES`            | String  | แอตทริบิวต์ทรัพยากร OpenTelemetry (คู่ key=value)                |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI`                 | Boolean | เปิดใช้งาน Effect HttpApi bridge               |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES`              | Boolean | เปิดใช้งานเวิร์กสเปซทดลอง                      |
