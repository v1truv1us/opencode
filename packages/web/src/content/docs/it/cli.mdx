...
| ------------------------------------- | ------- | --------------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT`               | string  | Credenziali di autenticazione JSON inline                       |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS`    | boolean | Disabilita caricamento skill da pacchetti npm                   |
...
| `OPENCODE_DISABLE_MOUSE`              | boolean | Disabilita cattura del mouse nella TUI                          |
| `OPENCODE_DISABLE_PRUNE`              | boolean | Disabilita la potatura dei dati vecchi                          |
| `OPENCODE_DISABLE_PROJECT_CONFIG`     | boolean | Disabilita caricamento config a livello di progetto             |
...
| `OPENCODE_MODELS_PATH`                | string  | Percorso personalizzato per file cache JSON dei modelli         |
...
| `EXA_API_KEY`                         | string  | Chiave API per ricerca web Exa (richiede `OPENCODE_ENABLE_EXA`) |
| `OTEL_EXPORTER_OTLP_ENDPOINT`         | string  | Endpoint exporter OpenTelemetry OTLP                            |
| `OTEL_EXPORTER_OTLP_HEADERS`          | string  | Header exporter OpenTelemetry OTLP                              |
| `OTEL_RESOURCE_ATTRIBUTES`            | string  | Attributi risorsa OpenTelemetry (coppie chiave=valore)          |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI`                 | boolean | Abilita bridge Effect HttpApi              |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES`              | boolean | Abilita workspace sperimentali             |
