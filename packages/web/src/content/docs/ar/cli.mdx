...
| المتغير                               | النوع   | الوصف                                                     |
| ------------------------------------- | ------- | --------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT`               | string  | بيانات اعتماد المصادقة JSON المُضمّنة                     |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS`    | boolean | تعطيل تحميل المهارات من حزم npm                           |
...
| `OPENCODE_DISABLE_MOUSE`              | boolean | تعطيل التقاط الماوس في TUI                                |
| `OPENCODE_DISABLE_PRUNE`              | boolean | تعطيل تنقية البيانات القديمة                              |
| `OPENCODE_DISABLE_PROJECT_CONFIG`     | boolean | تعطيل تحميل التهيئة على مستوى المشروع                     |
...
| `OPENCODE_MODELS_PATH`                | string  | مسار مخصص لملف ذاكرة التخزين المؤقت لـ JSON للنماذج       |
...
| `OPENCODE_TUI_CONFIG`                 | string  | مسار ملف تهيئة TUI                                        |
| `EXA_API_KEY`                         | string  | مفتاح API للبحث الويب Exa (يتطلب `OPENCODE_ENABLE_EXA`)   |
| `OTEL_EXPORTER_OTLP_ENDPOINT`         | string  | نقطة نهاية مصدّر OpenTelemetry OTLP                       |
| `OTEL_EXPORTER_OTLP_HEADERS`          | string  | رؤوس مصدّر OpenTelemetry OTLP                             |
| `OTEL_RESOURCE_ATTRIBUTES`            | string  | سمات موارد OpenTelemetry (أزواج مفتاح=قيمة)               |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI`                 | boolean | تفعيل جسر Effect HttpApi                    |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES`              | boolean | تفعيل مساحات العمل التجريبية                |
