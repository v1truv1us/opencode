...
| ------------------------------------- | -------- | ------------------------------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT`               | cadena   | Credenciales de autenticación JSON en línea                                     |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS`    | booleano | Deshabilitar la carga de habilidades desde paquetes npm                         |
...
| `OPENCODE_DISABLE_MOUSE`              | booleano | Deshabilitar la captura del ratón en la TUI                                     |
| `OPENCODE_DISABLE_PRUNE`              | booleano | Deshabilitar la poda de datos antiguos                                          |
| `OPENCODE_DISABLE_PROJECT_CONFIG`     | booleano | Deshabilitar la carga de configuración a nivel de proyecto                      |
...
| `OPENCODE_MODELS_PATH`                | cadena   | Ruta personalizada para el archivo caché JSON de modelos                        |
...
| `OPENCODE_TUI_CONFIG`                 | cadena   | Ruta al archivo de configuración TUI                                            |
| `EXA_API_KEY`                         | cadena   | Clave API para búsqueda web de Exa (requiere `OPENCODE_ENABLE_EXA`)             |
| `OTEL_EXPORTER_OTLP_ENDPOINT`         | cadena   | Endpoint del exportador OpenTelemetry OTLP                                      |
| `OTEL_EXPORTER_OTLP_HEADERS`          | cadena   | Encabezados del exportador OpenTelemetry OTLP                                   |
| `OTEL_RESOURCE_ATTRIBUTES`            | cadena   | Atributos de recursos de OpenTelemetry (pares clave=valor)                      |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI`                 | booleano | Habilitar puente Effect HttpApi                            |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES`              | booleano | Habilitar espacios de trabajo experimentales               |
