...
| Varijabla                             | Tip     | Opis                                                                 |
| ------------------------------------- | ------- | -------------------------------------------------------------------- |
| `OPENCODE_AUTH_CONTENT`               | string  | Inline JSON auth kredencijali                                        |
...
| `OPENCODE_DISABLE_EXTERNAL_SKILLS`    | boolean | Onemogući učitavanje vještina iz npm paketa                          |
...
| `OPENCODE_DISABLE_MOUSE`              | boolean | Onemogući hvatanje miša u TUI                                        |
| `OPENCODE_DISABLE_PRUNE`              | boolean | Onemogući brisanje (pruning) starih podataka                         |
| `OPENCODE_DISABLE_PROJECT_CONFIG`     | boolean | Onemogući učitavanje konfiguracije na nivou projekta                 |
...
| `OPENCODE_MODELS_PATH`                | string  | Prilagođena putanja za JSON keš datoteku modela                      |
...
| `EXA_API_KEY`                         | string  | API ključ za Exa web pretraživanje (zahtijeva `OPENCODE_ENABLE_EXA`) |
| `OTEL_EXPORTER_OTLP_ENDPOINT`         | string  | OpenTelemetry OTLP izvoznik endpoint                                 |
| `OTEL_EXPORTER_OTLP_HEADERS`          | string  | OpenTelemetry OTLP izvoznik zaglavlja                                |
| `OTEL_RESOURCE_ATTRIBUTES`            | string  | OpenTelemetry atributi resursa (parovi ključ=vrijednost)             |
...
| `OPENCODE_EXPERIMENTAL_HTTPAPI`                 | boolean | Omogući Effect HttpApi most                       |
...
| `OPENCODE_EXPERIMENTAL_WORKSPACES`              | boolean | Omogući eksperimentalne radne prostore            |
